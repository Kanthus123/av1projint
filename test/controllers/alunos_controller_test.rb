...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { curso: @aluno.curso, lasalle: @aluno.lasalle, matricula: @aluno.matricula, nome: @aluno.nome, pessoal: @aluno.pessoal } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { curso: @aluno.curso, lasalle: @aluno.lasalle, matricula: @aluno.matricula, nome: @aluno.nome, pessoal: @aluno.pessoal } }
